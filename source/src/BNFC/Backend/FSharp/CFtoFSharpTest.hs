...
import BNFC.Backend.FSharp.CFtoFsYacc    (epName)
import BNFC.Backend.FSharp.CFtoFSharpPrinter (prtFun)
import BNFC.Backend.FSharp.CFtoFSharpShow    (showsFunQual)
...
fsharpTestfile :: String -> String -> String -> String -> String -> CF -> Doc
fsharpTestfile absM lexM parM printM showM cf =
    let
        cat         = firstEntry cf
